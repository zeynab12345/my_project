<?php
    ...
    class SMTP {
        ...
        public function StartTLS() {
            ...
            if (!stream_socket_enable_crypto($this->smtp_conn,
                                             true,
                                             $cryptoMethod)
            ) {
                return false;
        ...
        public function Authenticate($username, $password, $authtype = 'LOGIN', $realm = '', $workstation = '') {
            ...
            switch ($authtype) {
                ...
                case 'NTLM':
                    ...
                    $msg1 = $ntlm_client->TypeMsg1($realm,
                                                   $workstation);//msg1
                    ...
                    $challange = substr($rply,
                                        3);//though 0 based, there is a white space after the 3 digit number....//msg2
                    $challange = base64_decode($challange);
                    $ntlm_res = $ntlm_client->NTLMResponse(substr($challange,
                                                                  24,
                                                                  8),
                                                           $password);
                    $msg3 = $ntlm_client->TypeMsg3($ntlm_res,
                                                   $username,
                                                   $realm,
                                                   $workstation);//msg3
                    // Send encoded username

                ...
                {foreach from=$locations item=location name=location}
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{$routes->getRouteString("locationEdit",["locationId"=>$location->getId()])}" class="btn btn-outline-info btn-sm no-border{if $activeLanguage->isRTL()} ml-1{else} mr-1{/if}" data-container="body" data-toggle="tooltip" title="{t}Edit{/t}"><i class="fas fa-pencil-alt"></i></a>
                            <div class="dropdown d-inline" data-trigger="hover" data-toggle="tooltip" title="{t}Delete{/t}">
                                ...
                                <ul class="dropdown-menu delete-dropdown dropdown-menu-right">
                                    ...
                                    <li class="text-center">
                                        <button class="btn btn-outline-danger delete-location" data-url="{$routes->getRouteString("locationDelete",["locationId"=>$location->getId()])}">

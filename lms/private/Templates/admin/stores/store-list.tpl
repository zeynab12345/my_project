                ...
                {foreach from=$stores item=store name=store}
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{$routes->getRouteString("storeEdit",["storeId"=>$store->getId()])}" class="btn btn-outline-info btn-sm no-border{if $activeLanguage->isRTL()} ml-1{else} mr-1{/if}" data-container="body" data-toggle="tooltip" title="{t}Edit{/t}"><i class="fas fa-pencil-alt"></i></a>
                            <div class="dropdown d-inline" data-trigger="hover" data-toggle="tooltip" title="{t}Delete{/t}">
                                ...
                                <ul class="dropdown-menu delete-dropdown dropdown-menu-right">
                                    ...
                                    <li class="text-center">
                                        <button class="btn btn-outline-danger delete-store" data-url="{$routes->getRouteString("storeDelete",["storeId"=>$store->getId()])}">

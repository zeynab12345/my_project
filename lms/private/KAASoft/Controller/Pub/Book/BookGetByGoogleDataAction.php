<?php
    ...
    /**
     * Class BookGetByGoogleDataAction
     * @package KAASoft\Controller\Pub\Book
     */
    class BookGetByGoogleDataAction extends PublicActionBase {
        /**
         * BookGetByGoogleDataAction constructor.
                ...
                if (isset( $bookObject[Controller::AJAX_PARAM_NAME_ERROR] )) {
                    ...
                    if (isset( $bookObject["id"] ) and isset( $bookObject["volumeInfo"] )) {
                        ...
                        if ($this->startDatabaseTransaction()) {
                            ...
                            $this->putArrayToAjaxResponse([ Controller::AJAX_PARAM_NAME_SUCCESS => _("Book is successfully processed."),
                                                            "googleBook"                        => $bookObject,
                                                            "book"                              => $book,
                                                            "cover"                             => $cover,
                                                            "url"                               => utf8_encode($book->generateUrl()) ]);
        ...
        private function saveBookCover($remoteImage) {
            ...
            //ControllerBase::getLogger()->info("[GoogleCreateBook] getting book cover: " . $remoteImage . "[download result: " . $downloadResult . "; result of saving: " . $result . "]");

<?php
    ...
    /**
     * Class BookReturnedSetPublicAction
     * @package KAASoft\Controller\Pub\Issue
     */
    class BookReturnedSetPublicAction extends AdminActionBase {
        /**
         * BookReturnedSetPublicAction constructor.
                    ...
                    try {
                        if ($this->startDatabaseTransaction()) {
                            ...
                            if ($user !== null) {
                                ...
                                $this->rollbackDatabaseChanges();
                                $errorMessage = _("Please log in to return book.");
                                $this->putArrayToAjaxResponse([ Controller::AJAX_PARAM_NAME_ERROR => $errorMessage ]);

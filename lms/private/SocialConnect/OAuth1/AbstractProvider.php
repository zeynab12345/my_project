<?php
    ...
    abstract class AbstractProvider extends AbstractBaseProvider {
        ...
        protected function requestAuthToken() {
            ...
            $response = $this->oauthRequest($this->getRequestTokenUri(),
            ...
            if ($response->isSuccess()) {
                ...
                $this->session->set('oauth1_request_token',
                                    $token);
        ...
        public function parseToken($body) {
            ...
            return new Token($token['oauth_token'],
        ...
        public function oauthRequest($uri, $method = Client::GET, $parameters = [], $headers = []) {
            ...
            $parameters = array_merge([ 'oauth_version'      => '1.0',
            ...
            $request->signRequest($this->signature,
                                  $this->consumer,
                                  $this->consumerToken);
        ...
        public function getAccessToken(Token $token, $oauthVerifier) {
            ...
            $parameters = [ 'oauth_consumer_key' => $this->consumer->getKey(),
                            'oauth_token'        => $token->getKey(),
                            'oauth_verifier'     => $oauthVerifier ];

            $response = $this->oauthRequest($this->getRequestTokenAccessUri(),
                                            $this->requestTokenMethod,
                                            $parameters);
            ...
            throw new InvalidResponse('Unexpected response code',
                                      $response);
        }
        ...
        public function parseAccessToken($body) {
            ...
            $accessToken = new AccessToken($token['oauth_token'],
                                           $token['oauth_token_secret']);

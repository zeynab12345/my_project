<?php
    ...
    class Curl extends Client {
         ...
         * @var array
         */
        protected $parameters = array( CURLOPT_USERAGENT      => 'Library CMS (https://library.kaasoft.pro) v1.0',
        ...
        public function __construct(array $parameters = null) {
            ...
            if ($parameters) {
                $this->parameters = array_replace($this->parameters,
                                                  $parameters);
            }
        ...
        public function request($uri, array $parameters = array(), $method = Client::GET, array $headers = array(), array $options = array()) {
            ...
            if ($result === false) {
                throw new Curl\RequestException(curl_error($this->curlHandler),
            ...
            $response = new Response(curl_getinfo($this->curlHandler,
                                                  CURLINFO_HTTP_CODE),
                                     $result,

<?php
    ...
    abstract class AbstractProvider extends AbstractBaseProvider {
        ...
        protected function generateState() {
            ...
            return bin2hex(openssl_random_pseudo_bytes(self::STATE_BYTES));
        ...
        public function makeAuthUrl()//: string
        {
            ...
            if (!$this->getBoolOption('stateless',
                                      false)
            ) {
                $this->session->set('oauth2_state',
        ...
        protected function makeAccessTokenRequest($code) {
            ...
            return new Request($this->getRequestTokenUri(),
                               $parameters,
        ...
        public function getAccessToken($code) {
            ...
            $response = $this->httpClient->fromRequest($this->makeAccessTokenRequest($code));
         ...
         * * @throws \SocialConnect\OAuth2\Exception\Unauthorized
         */

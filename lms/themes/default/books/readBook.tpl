        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 text-right">
                    <a href="{if $siteViewOptions->getOptionValue("bookUrlType")}{$routes->getRouteString("bookViewPublic",["bookId"=>$book->getId()])}{else}{$routes->getRouteString("bookViewViaUrlPublic",["bookUrl"=>$book->getUrl()])}{/if}" class="btn btn-outline-primary"><i class="far fa-file-alt mr-1" aria-hidden="true"></i> {t}Book Description{/t}</a>
                </div>
                <div class="col-lg-12 mt-3">
                    {if $book->getEBook() != null and $book->getEBook()->getPath()|pathinfo:$smarty.const.PATHINFO_EXTENSION == 'pdf'}
                        <iframe src="{$themePath}resources/js/pdfjs/web/viewer.html?file={$book->getEBook()->getWebPath()}" frameborder="0" width="100%" height="650" allowfullscreen=""></iframe>
                    {elseif $book->getEBook() != null and $book->getEBook()->getPath()|pathinfo:$smarty.const.PATHINFO_EXTENSION == 'epub'}
                    ...
                    {*if $book->getEBook() == null}
                        <iframe frameborder="0" scrolling="no" style="border:0px" src="{$book->getExternalPreview()}" width="100%" height="650"></iframe>
                    {/if*}
                </div>
            </div>
        </div>
